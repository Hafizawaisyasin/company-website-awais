...
//   auth: {
//     user: config.user.email,
//     pass: config.user.password, // generated ethereal password
//   },
// });
...
let mailOptions = { from: "hafizawaisyasin111@gmail.com" };
...
exports.sendMail = functions.https.onRequest((request, response) => {
  cors(request, response, () => {
    const { name, email, phone, message, total, users, customFeatures, category, service, platforms, features } = request.query;

    if (total) {
      if (category) {
        mailOptions = {
          from: "hafizawaisyasin111@gmail.com",
          to: `${email}`,
